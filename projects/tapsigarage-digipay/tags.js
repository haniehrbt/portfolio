const ALL_EVENT_TYPES = {
  ...
  VISIT_SLIDE04: `VISIT_SLIDE04`, // DONT TOUCH!!!!!!!!!!!!
  VISIT_SLIDE05: `VISIT_SLIDE05`, // DONT TOUCH!!!!!!!!!!!!
  VISIT_SLIDE06: `VISIT_SLIDE06`, // DONT TOUCH!!!!!!!!!!!!
  ...
  CLICK_AUTOPLAY: `AUTOPLAY1`, // DONT TOUCH!!!!!!!!!!!!
  LOOP: 'LOOP',
};
...
function fire_tag(EVENT_TYPE) {
  ...
  if (
    !Object.keys(ALL_EVENT_TYPES).includes(EVENT_TYPE) &&
    !Object.values(ALL_EVENT_TYPES).includes(EVENT_TYPE)
  ) {
    console.warn('THIS TAG IS NOT ALLOWED:', EVENT_TYPE);
    return;
  }
  const eventValue = ALL_EVENT_TYPES[EVENT_TYPE] || EVENT_TYPE;
